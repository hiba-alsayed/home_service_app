...
class BookingElectricity extends StatefulWidget {
  const BookingElectricity({super.key});

  @override
  _BookingElectricityState createState() => _BookingElectricityState();
}

class _BookingElectricityState extends State<BookingElectricity> {
