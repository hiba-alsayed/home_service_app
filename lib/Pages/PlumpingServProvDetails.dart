...
import '../main.dart';
import 'BookingPlumbing.dart';

class PlumbingServProvDetails extends StatelessWidget {
  PlumbingServProvDetails({required this.provider});
  AllProviderSameServiceModel provider;
                    ...
                    ElevatedButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => BookingPlumbing()),
                        );
                      },
                      child: Row(
                        children: [
