...
import '../main.dart';
import 'BookingPainting.dart';

class PaintingServProvDetails extends StatelessWidget {
  PaintingServProvDetails({required this.provider});
                    ...
                    ElevatedButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => BookingPainting()),
                        );
                      },
                      child: Row(
                        children: [
