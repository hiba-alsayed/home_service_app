...
import '../main.dart';
import 'BookingElectricity.dart';

class ElectricityServProvDetails extends StatelessWidget {
  final AllProviderSameServiceModel provider;

  ElectricityServProvDetails({required this.provider});
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Padding(
            padding: const EdgeInsets.only(top: 38.0, left: 16, right: 16, bottom: 16),
            child: Column(
                    ...
                    ElevatedButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => BookingElectricity(),
                          ),
                        );
                      },
                      child: Row(
